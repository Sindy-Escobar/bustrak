...
@section('styles')
    ...
    <style>
        ...
        .form-card {
            ...
            padding: 2rem;
            max-width: 600px;
            margin: 0 auto; /* centra horizontalmente dentro de content-area */
        }
...
@section('content')
    <div class="form-card">
        <h2><i class="fas fa-building me-2"></i>Registrar Empresa</h2>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="telefono" class="form-control" value="{{ old('telefono') }}"
                           pattern="[839][0-9]{7}" title="El número debe comenzar con 8, 3 o 9 y tener 8 dígitos" required>
                </div>
            </div>
