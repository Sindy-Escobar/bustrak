...
@section('content')
    <style>
        ...
        .page-title { font-size: 2rem; font-weight: 700; color: #1a56db; display: flex; align-items: center; gap: 12px; margin-bottom: 25px; }
        .comprobante-card { background: white; border: 1px solid #e0e0e0; border-radius: 10px; overflow: hidden; }
        .comprobante-header { background: #eef4ff; padding: 24px 30px; border-bottom: 2px solid #e0e0e0; display: flex; justify-content: space-between; align-items: center; }
        .comprobante-header h2 { font-size: 1.3rem; font-weight: 700; color: #1a56db; margin: 0; display: flex; align-items: center; gap: 10px; }
        .codigo-badge { font-family: 'Courier New', monospace; font-size: 1.1rem; font-weight: 700; color: #1a56db; background: white; border: 2px solid #1a56db; padding: 6px 16px; border-radius: 8px; }
        .comprobante-body { padding: 30px; }
        .section-title { font-weight: 700; color: #1a56db; font-size: 14px; display: flex; align-items: center; gap: 8px; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 2px solid #eef4ff; }
        .datos-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 25px; }
        .dato-item { display: flex; flex-direction: column; gap: 4px; }
        .dato-label { font-size: 11px; color: #999; font-weight: 700; text-transform: uppercase; display: flex; align-items: center; gap: 6px; }
        .dato-label i { color: #1a56db; }
        .dato-valor { font-size: 15px; color: #333; font-weight: 500; }
        ...
        .resumen-financiero { background: #eef4ff; border-left: 4px solid #1a56db; border-radius: 8px; padding: 20px; margin-bottom: 25px; }
        .fila-resumen { display: flex; justify-content: space-between; font-size: 14px; margin-bottom: 10px; color: #555; }
        .fila-resumen.total { border-top: 2px solid #1a56db; padding-top: 10px; font-weight: 700; font-size: 16px; color: #1a56db; margin-bottom: 0; }
        .metodo-info { background: #fff8e1; border-left: 4px solid #ffc107; padding: 14px; border-radius: 8px; margin-bottom: 16px; font-weight: 600; color: #856404; display: flex; align-items: center; gap: 10px; }
        .tabla-datos { width: 100%; border-collapse: collapse; margin: 12px 0; }
        ...
        .btn-volver { padding: 10px 24px; background: white; color: #333; border: 1px solid #ddd; border-radius: 8px; font-weight: 600; cursor: pointer; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; font-size: 14px; }
        .btn-imprimir { padding: 10px 24px; background: #1a56db; color: white; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; display: inline-flex; align-items: center; gap: 8px; font-size: 14px; }
    ...
    <div class="page-container">
        ...
        <div class="comprobante-card">
            ...
            <div class="comprobante-body">
                ...
                <div class="section-title"><i class="fas fa-info-circle"></i> Información del Reembolso</div>
                ...
                <div class="section-title"><i class="fas fa-user"></i> Información del Cliente</div>
                <div class="datos-grid">
                    <div class="dato-item">
                ...
                <div class="section-title"><i class="fas fa-coins"></i> Detalles Financieros</div>
                ...
                <div class="section-title"><i class="fas fa-wallet"></i> Método de Reembolso</div>
                ...
                @if($reembolso->metodo_pago === 'transferencia')
                    <table class="tabla-datos">
                        <tr><th>Banco</th><td>{{ $reembolso->banco ?? 'N/A' }}</td></tr>
                        <tr><th>Número de Cuenta</th><td>{{ $reembolso->numero_cuenta ?? 'N/A' }}</td></tr>
                        <tr><th>Titular de Cuenta</th><td>{{ $reembolso->titular_cuenta ?? 'N/A' }}</td></tr>
                    </table>
                @elseif($reembolso->metodo_pago === 'cheque')
                    <table class="tabla-datos">
                        <tr><th>Nombre en Cheque</th><td>{{ $reembolso->titular_cuenta ?? 'N/A' }}</td></tr>
                    </table>
                ...
                @if($reembolso->notas)
                    <div class="section-title" style="margin-top: 20px;"><i class="fas fa-sticky-note"></i> Observaciones</div>
                    <div class="notas-box">{{ $reembolso->notas }}</div>
                @endif

                <div class="section-title" style="margin-top: 20px;"><i class="fas fa-cog"></i> Información de Procesamiento</div>
                <div class="datos-grid">
                    <div class="dato-item">
