    ...
    <main>
        <nav class="sidebar">
            ...
            <div class="brand-logo">
                <h2>
                    <img src="{{ asset('Imagenes/bustrak-logo.png') }}" alt="Logo"
            ...
            <div class="nav-section">
                <button class="btn-toggle d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
                ...
                <div class="collapse btn-toggle-nav {{ request()->routeIs('usuario.perfil*') ? 'show' : '' }}"
                    id="miCuenta">
                    ...
                    <a href="{{ route('puntos.index') }}"
                        class="{{ request()->routeIs('puntos.index') ? 'active' : '' }}">
                        Ver Puntos
                    </a>
                </div>
            </div>
            ...
            <div class="nav-section">
                <button class="btn-toggle" data-bs-toggle="collapse" data-bs-target="#servicioBuses"
                    aria-expanded="{{ request()->routeIs('cliente.servicios*', 'incidentes*', 'calificar*', 'comentarios*') ? 'true' : 'false' }}">
                    <span><i class="fas fa-bus"></i> Servicio de buses</span>
                    <i class="fas fa-chevron-right chevron"></i>
                </button>
                <div class="collapse btn-toggle-nav {{ request()->routeIs('cliente.servicios*', 'incidentes*', 'calificar*', 'comentarios*') ? 'show' : '' }}"
                    id="servicioBuses">
                    <a href="{{ route('calificar.chofer', 1) }}"
                        class="{{ request()->routeIs('calificar*') ? 'active' : '' }}">
                        <i class="fas fa-star me-2"></i> Calificar servicio
                    </a>
                    <a href="{{ url('cliente/servicios-por-estacion') }}"
                        class="{{ request()->is('cliente/servicios-por-estacion*') ? 'active' : '' }}">
            ...
            <div class="nav-section">
                ...
                <div class="collapse btn-toggle-nav {{ request()->routeIs('usuario.rutas*') ? 'show' : '' }}"
                    id="rutas">
                    <a href="{{ route('consulta-paradas.index') }}"
                        class="{{ request()->routeIs('consulta-paradas.index') ? 'active' : '' }}">
                        Consultar rutas
                    </a>
                </div>
            </div>
            ...
            <div class="nav-section">
                ...
                <div class="collapse btn-toggle-nav {{ request()->routeIs('usuario.soporte*') ? 'show' : '' }}"
                    id="soporte">
            ...
            <div class="nav-section">
                ...
                <div class="collapse btn-toggle-nav {{ request()->routeIs('solicitud.empleo.mis-solicitudes') ? 'show' : '' }}"
                    id="solicitud">
